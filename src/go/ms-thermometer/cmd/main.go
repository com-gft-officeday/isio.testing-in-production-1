...
import (
	...
	"com.gft.tsbo-training.src.go/ms-thermometer/msthermometer"
)
...
var usage []byte = []byte("ms-thermometer: [OPTIONS] ")

func main() {

	var ms msthermometer.MsMeasure
	msthermometer.InitFromArgs(&ms, os.Args, nil)
